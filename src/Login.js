...
function Login() {
  ...
  return (
    <div  className='login'>
        <Link to='/'>
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1024px-Amazon_logo.svg.png" alt='amazon_logo' className='login__logo'/>
        </Link>
        ...
        <div className="login__container">
            ...
            <button type='submit' onClick={register} className='login__registerButton'>Create Amazon Account</button>
        </div>
    </div>
  )
}
